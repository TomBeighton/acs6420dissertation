...
%% Adapted function by Tom Beighton 05/04/23 Changed Return Values
%   Used to calculate the points of interception between shockwaves.
%%***********************************************************************%
...
%                         interesction)
%%Changed 05/04/23 by Tom Beighton to rturn empty array if there is no
%%intersection.
%--------------------------------------------------------------------------
